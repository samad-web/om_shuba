-- Robust Product Localization Script
-- Updates translations based on English Name matches to ensure coverage even if SKUs differ/change.
...
UPDATE products SET category_ta = 'விவசாய கருவிகள்' WHERE category_ta IS NULL;
